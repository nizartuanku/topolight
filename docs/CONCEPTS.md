...
```
curl -LO https://github.com/nizartuanku/topolight/releases/latest/download/topolight_0.4.3_linux_amd64.tar.gz
curl -LO https://github.com/nizartuanku/topolight/releases/latest/download/SHA256SUMS
grep topolight_0.4.3_linux_amd64.tar.gz SHA256SUMS | sha256sum -c -
tar xzf topolight_0.4.3_linux_amd64.tar.gz
cd topolight_0.4.3_linux_amd64
./topolight
```
